...
import { Users, Heart, Globe2, Medal, ArrowRight, Mail, Phone, MapPin, Github, Linkedin, Twitter } from 'lucide-react';
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        {stats.map((stat) => {
                            ...
                            return (
                                <Card key={stat.id} className="text-center p-6 hover:shadow-lg transition-shadow">
            ...
            <section className="py-16 bg-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-lg text-gray-600 mb-8">
                        We believe in the power of connection to transform communities and create lasting social impact.
                        Our platform brings together social organizations, volunteers, and resources to address the world's
                        most pressing challenges. Through technology and collaboration, we're building a more inclusive
